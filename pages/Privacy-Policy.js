    ...
    <div>
      <div className={styles.wrapper}>
        <div className={styles.textsection}>
          ...
          <p>
            Felix Melchner (“us”, “we”, or “our”) operates the
            www.felixmelchner.de website (the “Service”).
          </p>
          <p>
            This page informs you of our policies regarding the collection, use,
            and disclosure of personal data when you use our Service and the
            choices you have associated with that data. Our Privacy Policy for
            Felix Melchner is managed through Free Privacy Policy.
          </p>
          <p>
          ...
          <h2>Use of Data</h2>
          <p>Felix Melchner uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>
            Felix Melchner will take all steps reasonably necessary to ensure
          ...
          <p>
            Felix Melchner may disclose your Personal Data in the good faith
            belief that such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>
              To protect and defend the rights or property of Felix Melchner
            </li>
            <li>
          ...
          <p>
            By email:{" "}
            <a href="mailto: mail@felixmelchner.de">mail@felixmelchner.de</a>
          </p>
        </div>
      </div>
    </div>
